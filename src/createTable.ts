...
export const createTable = (table: ITable) => {
  ...
  table.col.forEach((c, i) => {
    const rowMap = new Map<string, string>();
    map.set(c, rowMap);
    table.row.forEach((r, j) => {
...
export const create32bitModRmTable = () => {
  return createTable({
    col: ['set1', 'set2', 'set3', 'set4', 'set5', 'set6', 'set7', 'set8'],
    row: ['set1', 'set2', 'set3', 'set4', 'set5', 'set6', 'set7', 'set8',
...
export const create32bitSIBtable = () => {
  return createTable(
    {
      col: ['eax', 'ecx', 'edx', 'ebx', 'esp', '[*]', 'esi', 'edi'],
      row: ['[eax]', '[ecx]', '[edx]', '[ebx]', 'none', '[ebp]', '[esi]', '[edi]', '[eax*2]', '[ecx*2]', '[edx*2]', '[ebx*2]', 'none', '[ebp*2]', '[esi*2]', '[edi*2]', '[eax*4]', '[ecx*4]', '[edx*4]', '[ebx*4]', 'none', '[ebp*4]', '[esi*4]', '[edi*4]', '[eax*8]', '[ecx*8]', '[edx*8]', '[ebx*8]', 'none', '[ebp*8]', '[esi*8]', '[edi*8]'],
...
export const create16bitRmTable = () => {
  return createTable({
    col: ['set1', 'set2', 'set3', 'set4', 'set5', 'set6', 'set7', 'set8'],
    row: ['[bx+si]', '[bx+di]', '[bp+si]', '[bp+di]', '[si]', '[di]', 'disp16', ' [bx]', '[bx+si]+disp8', '[bx+di]+disp8', '[bp+si]+disp8', '[bp+di]+disp8', '[si]+disp8', '[di]+disp8', '[bp]+disp8', '[bx]+disp8', '[bx+si]+disp16', '[bx+di]+disp16', '[bp+si]+disp16', '[bp+di]+disp16', '[si]+disp16', '[di]+disp16', '[bp]+disp16', '[bx]+disp16'
      , 'set1', 'set2', 'set3', 'set4', 'set5', 'set6', 'set7', 'set8'],
    value: [['00', '08', '10', '18', '20', '28', '30', '38'],
      ['01', '09', '11', '19', '21', '29', '31', '39'],
      ['02', '0A', '12', '1A', '22', '2A', '32', '3A'],
      ['03', '0B', '13', '1B', '23', '2B', '33', '3B'],
      ['04', '0C', '14', '1C', '24', '2C', '34', '3C'],
